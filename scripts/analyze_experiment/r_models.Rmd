...
formula_list[['dist']] <- "condition + condition*creativity_human + condition*create_gap + creativity_human + trial_no + create_gap + ai_feeling + interest_group + condition_order + log_duration + n_seeds + (1|participant_id) + (1|item_condition/response_chain_id)"

formula_list[['sim']] <- "condition + condition*creativity_human + condition*create_gap + condition*interest_group + creativity_human + trial_no + create_gap + ai_feeling + interest_group + condition_order + log_duration + n_seeds + (1|participant_id) + (1|item_condition/response_chain_id)"

formula_list[['orig']] <-  "condition + condition*creativity_human + condition*create_gap + condition*interest_group + creativity_human + trial_no + create_gap + ai_feeling + interest_group + condition_order + log_duration + n_seeds + (1|participant_id) + (1|item_condition/response_chain_id)"
...
create_plot <- function(model_name) {
  ...
  condition_labels <- c(
    "Control" = "Human\nControl",
    "HiExposure_Label  " = "Hi Exposure\n(Labeled)",
    "LoExposure_Label" = "Lo Exposure\n(Labeled)",
    "HiExposure_Unlabel" = "Hi Exposure\n(Unlabeled)",
    "LoExposure_Unlabel" = "Lo Exposure\n(Unlabeled)"
  )
