...
def run(n_trials_per_combo=1):
    ...
    prompts = {
        ...
        "zero_limit": "What are some creative uses for [OBJECT_NAME]? The goal is to come up with a creative idea that strikes people as clever, unusual, interesting, uncommon, humorous, innovative, or different. List [N] creative uses for [OBJECT_NAME]. Make sure each response is around {} words.".format(mean_word_count),
